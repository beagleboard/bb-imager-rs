...
The GUI can be run in a debug mode that exposes https://github.com/hecrj/comet[comet], Iced's inspector/debugger. Press `F12` in the running application to open it.

This requires the https://dioxuslabs.com/learn/0.6/CLI/installation/[Dioxus CLI] (`dx`), since debug mode relies on its `serve` command:
