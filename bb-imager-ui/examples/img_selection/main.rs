...
impl Catalog {
    fn items(&self, parent: Option<i64>) -> Box<[image_selection::ImageItem]> {
        self.0
            .iter()
            .filter(|(p, _)| *p == parent)
            .map(|(_, x)| x.clone())
    ...
    fn parent(&self, sublist: i64) -> Option<i64> {
        self.0
            .iter()
            .find(|(_, x)| {
                matches!(x.id, image_selection::ImageId::OsSublist((id, _)) if id == sublist)
            })
            .and_then(|(p, _)| *p)
    }
}
        ...
        let catalog = Catalog(vec![
            (
                ...
                image_selection::ImageItem {
                    id: image_selection::ImageId::OsImage(1),
            ...
            (
                None,
                image_selection::ImageItem {
                    id: image_selection::ImageId::OsSublist((10, config::Flasher::SdCard)),
            ...
            (
                None,
                image_selection::ImageItem {
                    id: image_selection::ImageId::Local(config::Flasher::SdCard),
            ...
            (
                None,
                image_selection::ImageItem {
                    id: image_selection::ImageId::Format,
            ...
            (
                Some(10),
                image_selection::ImageItem {
                    id: image_selection::ImageId::OsImage(2),
            ...
            (
                Some(10),
                image_selection::ImageItem {
                    id: image_selection::ImageId::OsSublist((11, config::Flasher::SdCard)),
            ...
            (
                Some(11),
                image_selection::ImageItem {
                    id: image_selection::ImageId::OsImage(3),
            ...
            (
                Some(11),
                image_selection::ImageItem {
                    id: image_selection::ImageId::OsImage(4),
    ...
    let app = iced::application(
        ...
        |s: &mut State, msg| {
            match msg {
                ...
                Message::SelectOs(image_selection::ImageId::OsSublist((id, _))) => {
                    s.goto(Some(id));
                }
